...
@NgModule({
  ...
  declarations: [BookSearchComponent, BookSearchPage, BookGridComponent, BookDetailsPage, BookLinksComponent, BookActionsPopoverComponent],
  entryComponents: [BookActionsPopoverComponent]
})
